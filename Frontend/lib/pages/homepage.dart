        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              ...
              activeIcon:
                  Icon(Icons.date_range, color: Colors.white, size: 26.0),
              title: Text(
                'Programmes',
            ...
            BottomNavigationBarItem(
              icon:
                  Icon(Icons.calendar_today, color: Colors.white70, size: 22.0),
              activeIcon:
                  Icon(Icons.calendar_today, color: Colors.white, size: 26.0),
              title: Text(
                'Séances',
                style: TextStyle(color: Colors.white),
              ),
            ...
            BottomNavigationBarItem(
              icon:
                  Icon(Icons.fitness_center, color: Colors.white70, size: 22.0),
              activeIcon:
